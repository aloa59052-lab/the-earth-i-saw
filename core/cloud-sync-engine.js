// ==========================================
// GOOGLE DRIVE SYNC ENGINE (SMART SYNC FIXED)
// ==========================================
    ...
    authorize: function(callback) {
        ...
        if (gapi.client.getToken() === null) {
            this.tokenClient.callback = async (resp) => {
                ...
                // await যুক্ত করা হয়েছে যাতে ডাটা ডাউনলোড শেষ হওয়া পর্যন্ত অপেক্ষা করে
    ...
    downloadData: async function() {
        ...
        try {
            ...
            if (response.body) {
                ...
                // 🕒 স্মার্ট কনফ্লিক্ট রেজোলিউশন (টাইমস্ট্যাম্প চেক)
